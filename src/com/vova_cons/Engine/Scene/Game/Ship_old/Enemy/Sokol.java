...
public class Sokol extends Enemy {
    private int shotCounter = 0;
    private static final int MAX_SHOTS = 10;

    public Sokol(Element enemySettings, Point position) {
    ...
    @Override
    protected void move() {
        super.goTo(GameScene.getPlayer().getCenter().offset(Point.create(Math.random()*SHOT_ANGLE - SHOT_ANGLE/2, 100)));
    }
